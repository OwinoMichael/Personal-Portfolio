...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_ypojlsa', 'template_bitsnzm', form.current, {
  ...
  return (
    <section className='contact section' id='contact'>
      ...
      <div className='contact__container container grid'>
        ...
        <div ref={infoRef} className='contact__content sr-left'>
          ...
          <div className='contact__info'>
            ...
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>mike0wi17@gmail.com</span>
            ...
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>+1-519-572-7199</span>
              <a href='https://api.whatsapp.com/send?phone=254725111378&text=Hello, more information!' className='contact__button'>
                Write me <i className='bx bx-right-arrow-alt contact__button-icon'></i>
              </a>
            </div>
        ...
        <div ref={formRef} className='contact__content sr-right'>
          ...
          <form ref={form} onSubmit={sendEmail} className='contact__form'>
            ...
            <button className='button button--flex'>
              Send Message
              <svg className="button__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="var(--container-color)">
